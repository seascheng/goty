/**
 * Placement math for anchored popovers. Kept away from the DOM so the
 * flipping and clamping rules can be tested directly.
 *
 * Ported from monocode (https://github.com/hardbeat920/monocode),
 * src/lib/popover.ts — MIT license. Copyright (c) 2025 monocode
 * contributors.
 */
