...
/// Colors are HEX STRINGS, not NSColor: this is Core (zero AppKit) —
/// the UI layer owns the NSColor/material treatment (AgentSpecStyle).
struct AgentSpec {
    let label: String
    let icon: String
...
enum AgentCatalog {
    ...
    static let specs: [String: AgentSpec] = [
        "claude": AgentSpec(label: "Claude Code", icon: "sparkles", accentHex: "#D97757"),
        "claude-code": AgentSpec(label: "Claude Code", icon: "sparkles", accentHex: "#D97757"),
        "codex": AgentSpec(label: "Codex", icon: "curlybraces", accentHex: "#101010"),
        "omp": AgentSpec(label: "OhMyPi", icon: "brain.head.profile", accentHex: "#F97316"),
        "pi": AgentSpec(label: "Pi", icon: "function", accentHex: "#0EA5E9"),
        "opencode": AgentSpec(label: "OpenCode", icon: "chevron.left.forwardslash.chevron.right", accentHex: "#6E56CF"),
        "gemini": AgentSpec(label: "Gemini CLI", icon: "diamond", accentHex: "#4285F4"),
        "grok": AgentSpec(label: "Grok CLI", icon: "bolt", accentHex: "#101010"),
        "aider": AgentSpec(label: "Aider", icon: "wrench.and.screwdriver", accentHex: "#8B5CF6"),
        "goose": AgentSpec(label: "Goose", icon: "bird", accentHex: "#9A8CFF"),
        "copilot": AgentSpec(label: "Copilot CLI", icon: "person.crop.circle", accentHex: "#8957E5"),
        "crush": AgentSpec(label: "Crush", icon: "hexagon", accentHex: "#00C2D1"),
        "sgpt": AgentSpec(label: "ShellGPT", icon: "ant.fill", accentHex: "#10A37F"),
