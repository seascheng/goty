...
extension Ghostty {
    ...
    class App: ObservableObject {
        ...
        private static func checkForUpdates(
            ...
            // GOTY: Sparkle-based updates are not part of this shell.
        }
        ...
        private static func toggleVisibility(
            ...
            // GOTY: no dock visibility toggling in this shell.
        }
        ...
        private static func gotoSplit(
            ...
            direction: ghostty_action_goto_split_e) -> Bool {
                // GOTY: split navigation is handled by Goty itself.
                _ = target
                _ = direction
                return false
        }
        ...
        private static func gotoWindow(
            ...
            while index != startIndex {
                ...
                if candidate.isVisible, !candidate.isMiniaturized {
                    ...
                    // GOTY: surface focus handled by key window.
                    return true
                }
        ...
        private static func toggleFloatWindow(
            ...
            case GHOSTTY_TARGET_SURFACE:
                ...
                // GOTY: no float-on-top menu to sync.
        ...
        private static func toggleBackgroundOpacity(
            ...
            case GHOSTTY_TARGET_SURFACE:
                break // GOTY: background opacity toggle not wired.
